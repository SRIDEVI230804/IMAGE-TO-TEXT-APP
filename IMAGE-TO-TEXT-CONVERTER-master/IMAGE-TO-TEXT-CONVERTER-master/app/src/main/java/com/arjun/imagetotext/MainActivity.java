...
public class MainActivity extends AppCompatActivity {
    ...
    private void showSaveDialog() {
        String[] items = {"Save as Text", "Save as PDF", "Save as Word"};
        AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        dialog.setTitle("Save Text As");
    ...
    private void saveToPdf(String mstring) {
        String timestamp = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.getDefault()).format(System.currentTimeMillis());
        try {
            File path = Environment.getExternalStorageDirectory();
            File dir = new File(path + "/Image To Text/");
            dir.mkdir();
            String filename = "ImageFile_" + timestamp + ".pdf";
            File file = new File(dir, filename);
            Document document = new Document();
            PdfWriter.getInstance(document, new FileOutputStream(file));
            document.open();
            document.add(new Paragraph(mstring));
            document.close();
            Toast.makeText(MainActivity.this, filename + " is saved to\n " + dir, Toast.LENGTH_LONG).show();
    ...
    private void saveToWord(String mstring) {
        String timestamp = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.getDefault()).format(System.currentTimeMillis());
        try {
            File path = Environment.getExternalStorageDirectory();
            File dir = new File(path + "/Image To Text/");
            dir.mkdir();
            String filename = "ImageFile_" + timestamp + ".docx";
            File file = new File(dir, filename);
